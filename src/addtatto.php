...
<body>
    ...
    <div class="container" style="background-color: none;">
        <div class="box">
          ...
          <option>ESTILO PRÓPRIO</option>   
        </select><br><br>
        <div class="inputBox">
                    <input type="text" name="estilo" id="estilo" class="inputUser">
                    <label for="estilo" class="labelInput">Nome da tatuagem</label>
                </div>
                <br>
        <div class="inputBox">
        ...
        <div class="inputBox">
            ...
            <label for="link" class="labelInput">Link da imagem de referência</label>
        </div>
        <br><br>
